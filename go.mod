...
replace (
	...
	github.com/agl/ed25519 => github.com/agl/ed25519 fd4d107ace12 // latest commit before the author shutdown the repo; see https://github.com/golang/go/issues/20504
